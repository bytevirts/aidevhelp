...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '糖哥', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ALL IN AI, 智能体，工作流，无代码开发🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://aidev.help', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI DEV, tutorial, ai web', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，这里是你的AI WEB开发助手,海量精选教程及最佳实践🎉',
